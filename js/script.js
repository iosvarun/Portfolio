...
function showAboutIntroductionTexts() {
  if (!aboutSectionEntered) {
    new Typed("#work", {
      strings: [
        "Currently working @ <span class = 'color-primary'>TO THE NEW, ex-Helix Tech Info Systems</span>",
      ],
      typeSpeed: 20,
      loop: false,
      startDelay: 0,
                        ...
                        "I <span class = 'color-primary'>love</span> to talk about <span class = 'color-primary'>iOS</span>, <span class = 'color-primary'>technology</span> and <span class = 'color-primary'>life</span>.",
                          ...
                          onComplete: function () {
                            new Typed(".contribution-text", {
                              strings: [
                                "I connect with awesome people, and help other developers with iOS dev.",
                              ],
                              typeSpeed: 30,
                              loop: false,
                              startDelay: 0,
